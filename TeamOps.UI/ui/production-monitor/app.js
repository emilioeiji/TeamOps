...
Object.assign(I18N["ja-JP"], {
    title: "Kadouritsu / 設備モニター",
    subtitle: "設備の稼働時間をエリア、設備、予定作業者、比較履歴で確認します。",
    metaUser: "ユーザー",
    metaOperator: "作業者",
    metaPeriod: "期間",
    badge: "生産モニター",
    toolbarTitle: "シフトフィルター",
    toolbarSubtitle: "ファイルを取り込み、対象を選択して、エリア別から設備別へ Kadouritsu を確認します。",
    date: "日付",
    shift: "シフト",
    sector: "工程",
    local: "エリア",
    ...
    metricStopped: "停止",
    metricIgnored: "除外",
    metricAvgOperating: "平均運転",
    metricError: "異常分",
    metricInactive: "無効分",
    forecastTitle: "G-Bareru 予測",
    forecastSubtitle: "ECII、Bunkatsu、DCS、Haidai 配置を基にした能力シミュレーション。",
    forecastReal: "実績",
    forecastPredicted: "予測",
    forecastDifference: "差分",
    forecastPeople: "人数",
    forecastCycle: "予測サイクル",
    forecastCapacity: "能力",
    forecastUnavailable: "予測不可",
    forecastBottleneck: "ボトルネック",
    areaBoardTitle: "エリア別パネル",
    areaBoardSubtitle: "主要リストはエリア別に集約し、全設備表示で画面が大きくなりすぎないようにします。",
    areaDetailTitle: "エリア詳細",
    areaDetailSubtitle: "エリアをクリックすると、設備と予定作業者を表示します。",
    areaFocusLabel: "対象エリア",
    areaSummaryTemplate: "設備 {machines} 台、運転 {running}、停止 {stopped}、除外 {ignored}、予定作業者 {operators} 名。",
    areaMachineCount: "設備",
    areaKadouritsu: "Kadouritsu",
    areaRunningMinutes: "運転分",
    areaLastUpdate: "最終更新",
    areaOperatorsTitle: "予定作業者",
    tableTitle: "設備別サマリー",
    tableSubtitle: "選択エリア内の設備一覧です。行をクリックすると履歴を確認できます。",
    colMachine: "設備",
    colStatus: "Status",
    colRecipe: "レシピ",
    colLot: "ロット",
    ...
    rankingSubtitle: "選択エリア内の停止・異常の累積影響です。",
    shiftCompareTitle: "Hirukin vs Yakin",
    shiftCompareSubtitle: "同じ日付・条件でシフト別の運転時間を比較します。",
    operatorRankingTitle: "作業者別推定ランキング",
    operatorRankingSubtitle: "エリア/シフト別の推定履歴です。ペア作業のエリアでは両作業者に同じエリア結果を付与します。",
    dailyTrendTitle: "日別履歴",
    dailyTrendSubtitle: "選択シフトの Kadouritsu 推移を直近日で表示します。",
    areaHistoryTitle: "エリア別履歴",
    areaHistorySubtitle: "同じシフト条件で直近日のエリア比較を表示します。",
    detailTitle: "設備の直近履歴",
    detailSubtitle: "選択設備に取り込まれた直近イベントです。",
    detailDate: "日時",
    detailStatus: "Status",
    detailRecipe: "レシピ",
    detailLot: "ロット",
    detailSource: "ファイル",
    timelineTitle: "エリアタイムライン",
    timelineSubtitle: "選択エリアの設備状態を 5 分単位で表示します。",
    loadingDefault: "読み込み中...",
    loadingRefresh: "データ更新中...",
    loadingImport: "ファイル取込中...",
    loadingReimport: "既存データを整理して再取込中...",
    loadingDetail: "詳細を読み込み中...",
    noRows: "選択エリアに設備がありません。",
    noAreas: "条件に一致するエリアがありません。",
    noRanking: "このエリアに停止記録はありません。",
    noTimeline: "タイムラインを作成するデータがありません。",
    noTrend: "履歴データがありません。",
    noOperators: "予定作業者なし",
    noOperatorRanking: "作業者別の推定に必要なスケジュールが不足しています。",
    operatorHistoryTitle: "作業者履歴",
    operatorHistorySubtitle: "選択作業者の日別・エリア別管理ビューです。",
    operatorHistoryDate: "日付",
    operatorHistoryArea: "エリア",
    operatorHistoryPercent: "% Kadouritsu",
    operatorHistoryRun: "運転分",
    operatorHistoryStop: "停止",
    operatorHistoryError: "異常",
    operatorHistoryCoverage: "カバー",
    operatorHistoryAvg: "平均",
    operatorHistoryAreas: "エリア",
    operatorHistoryEmpty: "この条件の作業者履歴はありません。",
    operatorCoverageFull: "フルシフト",
    operatorCoverageLate: "遅刻による一部",
    operatorCoverageEarlyLeave: "早退による一部",
    operatorCoverageReplacementLate: "遅刻カバー",
    operatorCoverageReplacementEarlyLeave: "早退カバー",
    operatorCoveragePartialDays: "一部日数",
    operatorCoverageFullDays: "フル日数",
    operatorCoverageWindow: "時間帯",
    ...
    compareMachines: "設備",
    estimatedLabel: "推定",
    currentAreaFallback: "全エリア",
    machineMinutesRunning: "運転",
    machineMinutesStopped: "停止",
    machineMinutesError: "異常",
    impactLabel: "影響",
    rankingMinutesSuffix: "分の影響",
    machineProcessLabel: "EC2 時間",
    machineIgnoredLabel: "除外",
    machineInvalidTimeLabel: "有効な EC2 時間なし",
    machineStoppedTimeLabel: "EC2 上で設備停止"
});
